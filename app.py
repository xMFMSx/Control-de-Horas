...
.contenedor-tabla {
    ...
    grid-template-columns: 6% 10% 8% 9% 8% 20% !important;
    width: 100% !important;
    align-items: center !important;
    box-sizing: border-box !important;
    margin: 0 !important;
    ...
    if st.session_state.get("cambiando_password", False):
        ...
        # --- VISTA 2: RESUMEN MENSUAL CON CAJA UNIFICADA Y BOTÓN FLUIDO ---
            ...
            if registros_tabla:
                ...
                c_h1, c_h2 = st.columns([0.82, 0.18], vertical_alignment="center")
                with c_h1:
                    st.markdown('''
                ...
                for r in registros_tabla:
                    ...
                    c_dat, c_b = st.columns([0.82, 0.18], vertical_alignment="center")
                    with c_dat:
                        st.markdown(f'''
                        <div class="es-datos">
