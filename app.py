        ...
        # --- VISTA 2: RESUMEN MENSUAL CON TABLA LIMPIA Y LÁPIZ LATERAL ---
            ...
            if registros_tabla:
                ...
                for r in registros_tabla:
                    ...
                    with c_lapiz:
                        # Inyección directa de estilo en línea: achica y baja el botón con precisión de píxeles
                        st.markdown(f'''
                        <style>
                        ...
                        st.markdown('<div class="lapiz-lateral-wrapper" style="padding-top: 6px;">', unsafe_allow_html=True)
