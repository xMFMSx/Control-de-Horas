...
/* Fila horizontal principal de la tabla: GAP CERO para evitar que baje el botón */
...
/* Proporciones exactas: Tabla izquierda (91%), Botón derecha (9%) */
...
if not st.session_state.autenticado:
    ...
    if st.session_state.get("cambiando_password", False):
        ...
        # --- VISTA 2: RESUMEN MENSUAL EN FORMATO TABLA PERFECTO ---
